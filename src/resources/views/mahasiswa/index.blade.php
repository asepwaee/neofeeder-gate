...
<main class="main-content-wrapper bg-success">
    <div class="container">
        <h3 class="text-white">Data Mahasiswa Universitas Hang Tuah Pekanbaru</h3>
        <br>
        <br>
                    ...
                    <div class="form-group">
                        <select class="form-control" name="prodi" id="prodi">
                            ...
                            <option value="{{$prodi['id_prodi']}}">
                                {{$prodi['nama_jenjang_pendidikan'].'-'.$prodi['nama_program_studi']}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card bg-primary mb-3">
                                            <div class="card-body px-10 py-30">
                                                ...
                                                @php
                                                if(isset($_GET['semester']) && isset($_GET['prodi'])){ @endphp
                                                <small><a
                                                        href="{{route('mahasiswa.data',['prodi'=>$_GET['prodi'],'semester'=>$_GET['semester'],'status'=>'A'])}}"
                                                        target="_blank" class="text-white text-hover-light">Lihat Data
                                                    </a></small>
                                                @php
                                                }
                                                @endphp
                                    ...
                                    <div class="col-md-4">
                                        <div class="card bg-info mb-3">
                                            <div class="card-body px-10 py-30">
                                                ...
                                                if(isset($_GET['semester']) && isset($_GET['prodi'])){ @endphp
                                                <small><a
                                                        href="{{route('mahasiswa.data',['prodi'=>$_GET['prodi'],'semester'=>$_GET['semester'],'status'=>'C'])}}"
                                                        target="_blank" class="text-white text-hover-light">Lihat Data
                                                    </a></small>
                                                @php
                                                }
                                    ...
                                    <div class="col-md-4">
                                        <div class="card bg-danger mb-3">
                                            <div class="card-body px-10 py-30">
                                                ...
                                                if(isset($_GET['semester']) && isset($_GET['prodi'])){ @endphp
                                                <small><a
                                                        href="{{route('mahasiswa.data',['prodi'=>$_GET['prodi'],'semester'=>$_GET['semester'],'status'=>'N'])}}"
                                                        target="_blank" class="text-white text-hover-light">Lihat Data
                                                    </a></small>
                                                @php
                                                }
            ...
            <div class="col-md-12" style="margin-top:30px;">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            @php
                            if((!isset($_GET['prodi']) && !isset($_GET['semester'])) || ($_GET['prodi']=='semua' &&
                            $_GET['semester']!='')){ @endphp
                            <div class="col-md-12">
